...
// configuration step. It creates a namespace called `tinyDL`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", tinyDL::cmake::project_name, tinyDL::cmake::project_version) };
